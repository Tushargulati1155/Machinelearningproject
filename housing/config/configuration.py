from housing.entity.config_entity import DataIngestionConfig ,DataValidationConfig, DataTransformationConfig, ModePusherConfig, \
...
class configuration:
    ...
    def get_maodel_evaluation_config(self)->ModelEvaluationConfig:  
        pass

    def get_model_pusher_config(self)->ModePusherConfig:
        pass
    ...
    def get_training_pipeline_config(self)->TrainingPipelineConfig:
        try:
            ...
            training_pipeline_config[TRAINING_PIPELEINE_ARTIFACT_DIR_KEY])
