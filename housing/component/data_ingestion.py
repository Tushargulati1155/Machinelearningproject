...
class DataIngestion:
    ...
    def __init__(self, data_ingestion_config:DataIngestionConfig):
        try:
            logging.info(f"{'='*20}data ingetion log started.{'='*20}")
    ...
    def download_housing_data(self)->str:
        try:
            ...
            logging.info(f"Downoading file from :[{download_url}] into :[{tgz_file_path}] ")
    ...
    def extract_tgz_file(self,tgz_file_path):
        try:
            ...
            logging.info(f"Extraction completed successfullyt")
        except Exception as e:
            raise HousingExceptions(e, sys) from e
    ...
    def split_data_as_train_test(self):
        try:
            ...
            housing_data_frame["income_cat"]=pd.cut(housing_data_frame["median_income"],
                                                    ...
                                                    labels=[1,2,3,4,5])
            logging.info(f"splitting data inton train test")
